...
const FairHousing = (() => {
  ...
  const RULES = [
    ...
    { re: /\b(famil(?:y|ies)|kid|child)[- ]friendly\b/i, cls: 'Familial status', sev: 'high', why: 'Implies a preference for families with children.', fix: 'Try “welcoming” or describe the actual amenity.' },
    ...
    { re: /\b(safe|safer)\b(?!\s*(room|deposit|harbou?r|anchorage))/i, cls: 'Steering (safety)', sev: 'high', why: '“Safe” is a classic steering word — it can imply who lives there and creates liability if ever inaccurate.', fix: 'Remove safety claims entirely; describe the property instead.' },
