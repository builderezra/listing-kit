...
const CACHE = 'listing-kit-v66';
const ASSETS = [
  './', './index.html', './styles.css',
  './app.js', './generator.js', './fairhousing.js',
  './parser.js', './importer.js', './visuals.js', './flyer.js', './ai.js', './studio.js', './tour.js', './qr.js', './zip.js', './reel.js',
  './icon.svg', './manifest.webmanifest', './signature.woff2',
];
